...
class ModelEvaluation:
    ...
    def _map_gender_column(self,df):
        ...
        logging.info("mapping gender column to numbers")
    ...
    def evaluate_model(self)->EvaluateModelResponse:
        """
        this function is used to evaluaate trained model with production model to choose best model
        
        :return: bool valus based on results
        On Failure  :   Write an exception log and then raise an exception
        """
