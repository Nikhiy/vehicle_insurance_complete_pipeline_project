...
class ModelPusher:
    def __init__(self,model_evaluation_artifact:ModelEvaluationArtifact,model_pusher_config:ModelPusherConfig):
        ...
        self.proj1_estimator=Proj1Estimator(bucket_name=model_pusher_config.bucketname,model_path=model_pusher_config.s3_model_key_path)
    ...
    def initiate_model_pusher(self)->ModelPusherArtifact:
        ...
        try:
            ...
            model_pusher_artifact=ModelPusherArtifact(bucket_name=self.model_pusher_config.bucketname,s3_model_path=self.model_pusher_config.s3_model_key_path)
