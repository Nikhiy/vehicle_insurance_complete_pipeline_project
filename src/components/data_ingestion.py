...
class DataIngestion:#this constructor means that data_ingestion_config this is of type DataIngestionConfig and if nothing is given take the default one DataIngestionConfig()
    ...
    def export_data_into_feature_store(self)->pd.DataFrame:
        ...
        try:
            ...
            my_data=Proj1Data()
            dataframe = my_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config
                                                               .COLLECTION_NAME)
            logging.info(f"shape of df is{dataframe.shape}")
    ...
    def initiate_data_ingestion(self)->DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("got data form mongodb")
