...
from src.pipline.prediction_pipeline import VehicleDataClassifier,VehicleData
from src.pipline.training_pipeline import TrainPipeline

#here we are initializing the fastapi object
app=FastAPI()
#this gets the css styling from static folder
...
#route to render the main page with form
...
#route to trigger model training mpdel process
@app.get("/train")
async def trainRouteClient():
    """
    endpoint to trigger the model training pipeline
    """
    try:
